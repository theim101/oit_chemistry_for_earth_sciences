...
#plotting...
ax[0,0].plot(pH_list, calcite)
ax[0,1].plot(pH_list, CaCO3)
ax[0,2].plot(pH_list, Ca)
ax[1,0].plot(pH_list, CO3)
ax[1,1].plot(pH_list, HCO3)
ax[1,2].plot(pH_list, H2CO3)
...
plt.suptitle('Example 1: Results')
