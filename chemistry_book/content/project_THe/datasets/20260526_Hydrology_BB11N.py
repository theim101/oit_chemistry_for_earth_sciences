...
cellIdx = 0  # 0 ='PP-11N',1='PP-11Z',2='PP-12']
...
pklfiles = {'cumflow': './DataFiles/cumflow_data_BB11N.gz', 
            'level': './DataFiles/level_data_BB11N.gz',
            }
sens_names = {'flowsens': 'Flow_PP-11NCum',
              'levelsens': 'Level_PP-11N'}
...
cumflow_data = cumflow_data.rename(columns={'Flow_PP-11NCum': 'totalflow'})
...
totF_meas = totF_meas.rename(columns={0: 'totF'})
# %%