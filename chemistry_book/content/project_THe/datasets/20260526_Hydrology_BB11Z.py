...
cellIdx = 1  # 0 ='PP-11N',1='PP-11Z',2='PP-12']

lF = dbl.wastebodyPropertiesBB(cellIdx)  # m2

lF.to_excel('df_lF_BB11Z.xlsx')

# %% 
# Download flow and level data from CHRONOS
## Index to sensor names in the data base

pklfiles = {'cumflow': './DataFiles/cumflow_data_BB11Z.gz', 
            'level': './DataFiles/level_data_BB11Z.gz',
            }
sens_names = {'flowsens': 'Flow_PP-11ZCum',
              'levelsens': 'Level_PP-11Z'}
...
cumflow_data = cumflow_data.rename(columns={'Flow_PP-11ZCum': 'totalflow'})
...
totF_meas.to_excel('df_cumLeachate_BB11Z.xlsx')
# %%